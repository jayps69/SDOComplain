    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <table>
                ...
                <tbody>
                    <!-----DISPLAY DB INTO TABLE ---->
                <?php
        $query = "SELECT * FROM complaint"; // Make sure to replace 'your_table_name' with the actual name of your table
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td style='text-align: center;'>".htmlspecialchars($row['dts'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['name'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['email'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['contact'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['trn'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['category'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['subcategory'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['source'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['school'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['recieved'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['details'])."</td>";
                echo "<td style='text-align: center;'>".htmlspecialchars($row['lapsed'])."</td>";
        ...
        ?>
            ...
            <a href="exportExcel.php" id="unbtn12" class="unbtn12"><i class="fas fa-file-export"></i> Export Excel</a>
             ...
             <style>
                ...
                <div class="modal-content">
                    <!-----CHANGE MODAL TO FORM INSTEAD OF SCRIPT ---->
    <form action="importExcel.php" method="post" enctype="multipart/form-data">
        <h2>Import a File</h2>
        <input type="file" name="fileInput" id="fileInput" accept=".xls, .xlsx" style="margin-bottom: 10px;margin-top: 10px;">
        <button type="submit" name="submit" style="margin-bottom: 10px;">Import</button>
